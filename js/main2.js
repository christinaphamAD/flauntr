...
$(document).ready(function() {
	...
	var tag = $('#tag').val();
	alert(tag);
	var flickurl = 'http://api.flickr.com/services/rest/?method=flickr.tags.getRelated&api_key=556f8df433c4e4709df59873d845876f&tag='+tag+'&format=json&nojsoncallback=1';

	var jo = $.getJSON(flickurl,function(data,status){
//		alert("callback");
		alert(data.stat);
		var x = data.tags.tag;
		if(x.length>8){
